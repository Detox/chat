...
(function(){
  ...
  lib.ready(function(){
    test('Core', function(t){
      var generated_seed, generated_secret, x$, node_1_real_seed, node_1_real_public_key, y$, node_3_real_seed, node_3_real_public_key, nodes, wait_for, options, promise, i$, to$;
      ...
      function ready_callback(){
        var announcement_retry, connection_retry, node_1, node_3, chat_node_1, chat_node_3;
      ...
      function fn$(i){
        promise = promise.then(function(){
          return new Promise(function(resolve){
            ...
            x$.set([i]);
            if (i === 0) {
              instance = detoxCore.Core([], [], 5, 1, Object.assign({}, options, {
              ...
              instance = detoxCore.Core([bootstrap_node_info], [], 5, 1, Object.assign({
                dht_keypair_seed: dht_seed
              }, options));
            }
